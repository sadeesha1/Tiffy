...
# Main model — used for complex/reasoning turns (sonnet-class)
MODEL              = os.getenv("MODEL", "claude-sonnet-4-5")
# Fast model — used for casual chat turns and background summarization (haiku-class)
FAST_MODEL         = os.getenv("FAST_MODEL", "claude-haiku-4-5-20251001")
# Token budget for extended thinking. Set to 0 to disable.
